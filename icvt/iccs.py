...
class ICCS(ICCS_GUI, icvt.AppAncestor):
    ...
    #         buttons.append(button)
    #
    #     # # Add buttons from build_bottom_right_panel function
    #     # et_button = QPushButton()
    #     # et_button.setIcon(QIcon("resources/img/et.png"))
    #     # et_button.clicked.connect(lambda: os.startfile(self.annotation_file_path))
    #     # grid_layout.addWidget(et_button, 0, 5)
    #     # buttons.append(et_button)
    #     #
    #     # ef_button = QPushButton()
    #     # ef_button.setIcon(QIcon("resources/img/ef.png"))
    #     # ef_button.clicked.connect(lambda: os.startfile(os.path.dirname(self.annotation_file_path)))
    #     # grid_layout.addWidget(ef_button, 0, 6)
    #     # buttons.append(ef_button)
    #
    #     for button in buttons:
    #         button_width = screen_width // (len(buttons) + 5)
    #         button.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
